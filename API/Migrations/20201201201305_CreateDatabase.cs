        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewsListId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewsItems_NewsLists_NewsListId",
                        column: x => x.NewsListId,
                        principalTable: "NewsLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NewsItems_AspNetUsers_ResponsibleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsItems_NewsListId",
                table: "NewsItems",
                column: "NewsListId");

            migrationBuilder.CreateIndex(
                name: "IX_NewsItems_ResponsibleId",
                table: "NewsItems",
